...
\begin{figure}[!htp]
 ...
 \bicaption[fig:longcaptionbad]{这里将出现在插图索引}{海交通大学是我国历史最悠久的高等学府之一，是教育部直属、教育部与北京市共建的全国重点大学.}{Fig}{Where there is a will, there is a way.}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \begin{minipage}[b]{0.6\textwidth}
    ...
    \centering
    \includegraphics[width=4cm]{example/bjtulogo.pdf}
    \bicaption[fig:longcaptiongood]{这里将出现在插图索引}{海交通大学是我国历史最悠久的高等学府之一，是教育部直属、教育部与北京市共建的全国重点大学.}{Fig}{Where there is a will, there is a way.}
  \end{minipage}     
\end{figure}
