%# -*- coding: utf-8-unix -*-
%%==================================================
%% chapter01.tex for BJTU Master Thesis
%%==================================================

%\bibliographystyle{bjtu2}%[此处用于每章都生产参考文献]
\chapter{这是什么}
\label{chap:intro}

这是北京交通大学(非官方)学位论文 \LaTeX 模板，当前版本是 \version 。

最早的一版学位模板是一位热心的物理系同学制作的。
那份模板参考了自动化所学位论文模板，使用了CASthesis.cls文档类，中文字符处理则采用当时最为流行的 \CJKLaTeX 方案。
我根据交大研究生院对学位论文的要求
\footnote{\url{http://www.gs.bjtu.edu.cn/policy/fileShow.ahtml?id=130}}
...
现在，交大学位论文模板BJTUTHesis代码在github
\footnote{\url{https://github.com/weijianwen/BJTUThesis}}
上维护。
你可以\href{https://github.com/weijianwen/BJTUThesis/issues}{在github上开issue}
、或者在\href{https://bbs.bjtu.edu.cn/bbsdoc?board=TeX_LaTeX}{水源LaTeX版}发帖来反映遇到的问题。
...
bjtuthesis提供了一些常用选项，在thesis.tex在导入bjtuthesis模板类时，可以组合使用。
这些选项包括：
...
若需要生成包含“独创性声明扫描件”的学位论文文档，请将扫描件保存为statement.pdf，然后调用make生成submit.pdf。
...
bjtuthesis.cfg, bjtuthesis.cls和GBT7714-2005NLang.bst。
...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
	\item 中英文摘要(abstract.tex)。前言(frontmatter)的其他部分，中英文封面、独创性声明、授权信息在bjtuthesis.cls中定义，不单独分离为tex文件。
不单独弄成文件。
